...
Pavyzdys su duomenimis apie kūdikių svorį:

```{r}
load("C:/Users/rimas/OneDrive/Documents/MIF/Destymas/2017Pavasaris/Biometrika/bw.RData")
RegModel.1 <- lm(bwt~lwt, data=bw)
summary(RegModel.1)
```
